...
\begin{frame}[fragile]{Las librerías de las primeras sesiones}
\begin{columns}[T]
...
\column{0.25\linewidth}
\textbf{seaborn}\\ se apoya en matplotlib; gráficos estadísticos en una línea.
\end{columns}
\vfill
\begin{lstlisting}
import pandas as pd
...
\begin{frame}[fragile]{Los cuatro gráficos: matplotlib y seaborn}
La misma figura, dos formas de pedirla. seaborn recibe el \code{DataFrame} y los
nombres de columnas; el eje y \code{plt.show()} siguen siendo de matplotlib.
\begin{lstlisting}
# --- matplotlib ---
